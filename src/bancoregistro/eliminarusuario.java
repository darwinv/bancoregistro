...
usuario user = new usuario();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingrese el nombre de usuario a eliminar");
        ...
        res.beforeFirst();
           while (res.next()) {          
                ...
                if(res.getInt(4)== 1){
                       ...
                       if(res.getInt(5)==1){
                       this.jTextField4.setText("Usuario Normal");
                       }   
                       else{
                            this.jTextField4.setText("Administrador");
                          }
              }
        }
...
try {
            if(this.jTextField1.getText().equals(""))
              JOptionPane.showMessageDialog(this,"No se ha buscado el Usuario");
            else{
                if(user.getTempEstado()==2){
        JOptionPane.showMessageDialog(this,"Usuario Administrador no se puede Eliminar");
       } 
       else{
                usuario u=new usuario();
                u.setNombreUsuario(this.jTextField2.getText());
                Class.forName("com.mysql.jdbc.Driver");
                try (Connection conexion = DriverManager.getConnection ("jdbc:mysql://localhost/bancopueblo","root",""); Statement st = conexion.createStatement()) {
                    st.executeUpdate(u.eliminar());
                }
